/*
    ...
    parentProcessAssignment.c v0.0.1 
    (c) 2014 Aayush Chhabra
	
	it has the main method and redirects the commands accordingly.
...
int main(){
	...
	{
		getEnvironments = (char *)malloc(sizeof(char)*100);
		strcpy(getEnvironments, "/bin:.");
	}
	//printf("%s\n", getEnvironments);
	while(1){	
